    ...
    <body>
        ...
        <table width="600" border="1" align="center" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td bgcolor="#FFFFee"><strong>Quickstart Documentation:</strong></td>
          </tr>
          <tr>
            <td bgcolor="#FFFFee"><a href="http://example.dev">example.dev</a> - Drupal 7</td>
          ...
          <tr>
            <td bgcolor="#FFFFee">&nbsp;</td>
            <td bgcolor="#FFFFee"><a href="http://drupal.org/project/drush_make">Drush Make</a> reference</td>
          </tr>
          <tr>
            <td bgcolor="#FFFFee">&nbsp;</td>
